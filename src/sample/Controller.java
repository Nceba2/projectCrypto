...
public class Controller {
    ...
    @FXML protected void handleSubmitButtonAction(ActionEvent event) throws IOException {
        ...
        /**
         * file on this snippet is where input information is stored
         *and prepared to be encrypted or decrypted
         **/
        File inputFile = new File("document.txt");
        FileWriter fw = new FileWriter(inputFile);
        fw.write(inputInformation);
        fw.close();
        //the file where encrypted information will go
        File encryptedFile = new File("document1.encrypted");
        //the file where decrypted information will go
        File decryptedFile = new File("document1.decrypted");

        /**
         * The following snippet will try to encrypt and decrypt the
         *  document's information into the new files created
         *  **/
        try {
